...
- (void)viewDidLoad {
  ...
  _textLabel.text = [NSString stringWithFormat:kOMN_PREORDER_DONE_FORMAT, [[NSString omn_takeAfterIntervalString:self.visitor.delivery.minutes] lowercaseString], self.visitor.restaurant.address.text];
