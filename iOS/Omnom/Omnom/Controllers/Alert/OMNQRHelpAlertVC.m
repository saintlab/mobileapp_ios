...
- (void)viewDidLoad {
  ...
  NSMutableDictionary *attributes = [OMNUtils textAttributesWithFont:FuturaOSFOmnomRegular(18.0f) textColor:[UIColor lightGrayColor] textAlignment:NSTextAlignmentLeft];
  ...
  attributes[NSForegroundColorAttributeName] = colorWithHexString(@"4A90E2");
  _textLabel.linkAttributes = [attributes copy];
  
  attributes[NSForegroundColorAttributeName] = [colorWithHexString(@"4A90E2") colorWithAlphaComponent:0.5];
